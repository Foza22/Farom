...
void AFaromCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AFaromCharacter::OnResetVR);
}


void AFaromCharacter::OnResetVR()
{
	// If Farom is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Farom.Build.cs is not automatically propagated
